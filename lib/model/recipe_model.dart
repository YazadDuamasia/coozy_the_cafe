...
class RecipeModel  extends ISuspensionBean {
  ...
  @override
  String toString() {
    return 'RecipeModel{id: $id, recipeName: $recipeName, translatedRecipeName: $translatedRecipeName, recipeIngredients: $recipeIngredients, recipeTranslatedIngredients: $recipeTranslatedIngredients, recipePreparationTimeInMins: $recipePreparationTimeInMins, recipeCookingTimeInMins: $recipeCookingTimeInMins, recipeTotalTimeInMins: $recipeTotalTimeInMins, recipeServings: $recipeServings, recipeCuisine: $recipeCuisine, recipeCourse: $recipeCourse, recipeDiet: $recipeDiet, recipeInstructions: $recipeInstructions, recipeTranslatedInstructions: $recipeTranslatedInstructions, recipeReferenceUrl: $recipeReferenceUrl}';
  }

  @override
  String getSuspensionTag() {
    return translatedRecipeName != null && translatedRecipeName!.isNotEmpty ? translatedRecipeName![0].toUpperCase() : '';
  }
}
